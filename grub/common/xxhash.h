 ...
 */
static XXH_MALLOCF void* XXH_malloc(size_t s) { return AllocateZeroPool(s); }

/*!
 * @internal
 * @brief Modify this function to use a different routine than free().
 */
static void XXH_free(void* p) { FreePool(p); }
...
XXH_PUBLIC_API XXH_errorcode XXH32_reset(XXH32_state_t* statePtr, XXH32_hash_t seed)
{
    ...
    SetMem(statePtr, sizeof(*statePtr), 0);
                    ...
                    const void* secret, size_t secretSize)
{
    ...
    SetMem((char*)statePtr + initStart, initLength, 0);
